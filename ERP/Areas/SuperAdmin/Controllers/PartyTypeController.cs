    ...
    public class PartyTypeController : SettingsController
    {
        ...
        public IActionResult Index([FromQuery(Name = "grid-page")] string gridpage = "1", [FromQuery(Name = "grid-column")] string orderby = "", [FromQuery(Name = "grid-dir")] string sortby = "0", [FromQuery(Name = "grid-filter")] string gridfilter = "", [FromQuery(Name = "grid-search")] string search = "")
        {
            ...
            c.Add()
                ...
                .SetWidth(60)
                .Css("hidden-xs") //hide on phones
                .RenderValueAs(o => $"<a class='btn IndexPagebtnEidtPadding' onclick='fnPartyType(this)' href='javascript:void(0)' data-id='{o.PartyTypeID}' data-bs-toggle='offcanvas' data-bs-target='#canvas_PartyType' aria-controls='canvas_masterentity' ><i class='bx bx-edit'></i></a>");
            };
            PagedDataTable<PartyType> pds = iPartyType.GetAllPartyTypeAsync(gridpage.ToInt(), PAGESIZE, search, orderby.RemoveSpace(), sortby == "0" ? "ASC" : "DESC").Result;
            var server = new GridCoreServer<PartyType>(pds, query, false, "ordersGrid",columns, PAGESIZE, pds.TotalItemCount)
                .Sortable()
                //.Filterable()
                //.WithMultipleFilters()
