        ...
        public IActionResult Index([FromQuery(Name = "grid-page")] string gridpage = "1", [FromQuery(Name = "grid-column")] string orderby = "", [FromQuery(Name = "grid-dir")] string sortby = "0", [FromQuery(Name = "grid-filter")] string gridfilter = "", [FromQuery(Name = "grid-search")] string search = "")
        {
            ...
            Action<IGridColumnCollection<FinancialYearMaster>> columns = c =>
            {
                ...
                c.Add()
                    ...
                    .RenderValueAs(o => $"<a class='btn IndexPagebtnEidtPadding' onclick='fnFinancialYear(this)' href='javascript:void(0)' data-id='{o.FinancialYearID}' data-bs-toggle='offcanvas' data-bs-target='#canvas_FinancialYear' aria-controls='canvas_FinancialYear'><i class='bx bx-edit'></i> </a>");
