...
namespace ERP.Areas.Admin.Controllers
{
    ...
    public class VisitorRequestsController : SettingsController
    {
        ...
        public VisitorRequestsController(IVisitorService visitorService, IEmailService emailService, IViewRenderService viewRenderService, INotyfService notyf, ISuperAdminService masterService, IHostingEnvironment hostingEnvironment, IEmployeeService employeeService, ISecurityOfficerService securityOfficerService)
        {
            ...
            this._securityOfficerService = securityOfficerService;
        }
