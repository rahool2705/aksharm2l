...
namespace ERP.Controllers
{
    ...
    public class VisitorController : SettingsController
    {
        ...
        private IVisitorService _service { get; set; }
        private readonly IEmailService _emailService = null;
        private readonly INotyfService _notyf;
        private readonly IHostingEnvironment _env;
        private readonly IMasterService _masterService;
        private readonly IEmployeeService _employeeService; 
        public VisitorController(IConfiguration configuration, IEmailService emailService, INotyfService notyf, IHostingEnvironment hostingEnvironment, IMasterService masterService, IEmployeeService employeeService, IVisitorService visitorService)
        {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["IdentityProofType"] = new Microsoft.AspNetCore.Mvc.Rendering.SelectList(idProofList, "IdentityProofTypeID", "IdentityProofTypeText");
            var vehicleTypeList = new Business.Service.MasterService(_config).GetVehicleTypeAsync();
            ViewData["VehicleTypeID"] = new Microsoft.AspNetCore.Mvc.Rendering.SelectList(vehicleTypeList, "VehicleTypeID", "VehicleTypeText");
            var listEmployees = _masterService.GetAllEmployees();
            ViewData["MeetToWhomPersonName"] = new Microsoft.AspNetCore.Mvc.Rendering.SelectList(listEmployees, "EmployeeID", "EmployeeName");
            return View(model);
        }
        ...
        public JsonResult AutoComplete(string prefix)
        {
            try
            {
                ...
                var zipcodes = (from zip in zipcodeData
                                ...
                                select new
                                {
                                    label = string.Concat(zip.ZipCode,", ",zip.AreaOfficeName),
                                    val = zip.ZipCodeID
                                }).ToList();
